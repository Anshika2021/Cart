...
//        Integer userId = 1;
//
//        // Add some cart items for the user
//        CartItemWrapper cartItemWrapper1 = new CartItemWrapper();
//        cartItemWrapper1.setUserId(userId);
//        cartDao.save(cartItemWrapper1);
//
//        CartItemWrapper cartItemWrapper2 = new CartItemWrapper();
//        cartItemWrapper2.setUserId(userId);
//        cartDao.save(cartItemWrapper2);
//
//        // Call the remove all method
//        ResponseEntity<String> response = cartDao.removeAllByUserId(userId);
//
//        // Check if the response is successful
//        assertEquals(HttpStatus.OK, response.getStatusCode());
//
//        // Check if the cart items were removed
